            ...
            >
                  ...
                  <FormItem className="items-center justify-center w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Social Media Marketing">Solar Battery Storage</SelectItem>
                        <SelectItem value="Solar Maintenance & Repairs">Solar Maintenance & Repairs</SelectItem>
                        <SelectItem value="Solar Financing Options">Solar Financing Options</SelectItem>
                        <SelectItem value="Energy Efficiency Consultation">Energy Efficiency Consultation</SelectItem>
                      </SelectContent>
                    </Select>
                  </FormItem>
                )}
                  ...
                  <FormItem className="items-center justify-center  w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Learn More">Installation</SelectItem>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to Nalube&apos; sending marketing communications related
                  to Nalube
                </div>
              </div>
